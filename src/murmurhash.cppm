...
namespace detail {
    ...
    inline std::uint64_t getblock64(const std::uint64_t* p, int i) {
          return p[i];
    }
...
export std::uint64_t murmurhash3_x64_128(const void* key, int len, std::uint64_t seed) {
